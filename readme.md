...
<h1  align="center" >Random cocktail drinks</h1>
<!-- TABLE OF CONTENTS -->
<details>
...
This web app was created to allow users to search for their favorite cocktail drinks.
...
3.A button that, when clicked, takes the user to get more information about the drinks.
```
